...
%JAVACMD% %JAVA_OPTS% %EXTRA_JVM_ARGUMENTS% -classpath %CLASSPATH_PREFIX%;%CLASSPATH% -Dapp.name="CleanerBot" -Dapp.repo="%REPO%" -Dbasedir="%BASEDIR%" bot.Main %CMD_LINE_ARGS%
